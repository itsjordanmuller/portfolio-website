...
tags: ["software", "accessibility", "usability", "inclusion", "ethics", "design", "technology"]
---
...
Adhering to accessibility guidelines such as the [Web Content Accessibility Guidelines (WCAG)](https://www.w3.org/TR/WCAG21/) is crucial. However, it is equally important to consider the human interaction aspect of our designs. This is where 'usable accessibility' or accessible user experience (UX) comes into play.
